...
def make_receipt(data: list[list[str,int,float]], out_file_name: str, sundaes: int) -> None:
    # Takes order data and outputs a PDF receipt from it
    itemized_len: int = (data[-4][-1] * 2 + (sundaes))
    ...
    style = TableStyle(
      [
        ...
        ( "GRID" , ( 0, 0 ), ( 6 , itemized_len ), 1 , colors.black ),
